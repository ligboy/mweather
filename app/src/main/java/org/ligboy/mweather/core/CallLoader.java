 ...
 */
public abstract class CallLoader<T> extends Loader<Response<T>> {
     ...
     */
    public CallLoader(@NonNull Context context, @NonNull Call<T> call) {
        super(context);
     ...
     * @param call
     */
    public void setCall(@NonNull Call<T> call) {
        //noinspection ConstantConditions
        if (call == null) {
            throw new IllegalArgumentException("call can't be null.");
        }
